      ...
      .then(async (basket: BasketModel | null) => {
        if (basket != null) {
          ...
          db.ordersCollection.insert({
            ...
            paymentId: req.body.orderDetails ? security.sanitizeLegacy(req.body.orderDetails.paymentId) : null,
            addressId: req.body.orderDetails ? security.sanitizeLegacy(req.body.orderDetails.addressId) : null,
            orderId,
            delivered: false,
