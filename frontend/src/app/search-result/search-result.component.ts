...
import { type AfterViewInit, Component, NgZone, type OnDestroy, ViewChild, ChangeDetectorRef, SecurityContext } from '@angular/core'
...
export class SearchResultComponent implements OnDestroy, AfterViewInit {
  ...
  filterTable () {
    ...
    if (queryParam) {
      ...
      this.searchValue = this.sanitizer.bypassSecurityTrustHtml(sanitizedQueryParam) // vuln-code-snippet vuln-line localXssChallenge xssBonusChallenge
